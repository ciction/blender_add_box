...
#        
#        #back
#        Vector((-1 * scale_x/2, 1 * scale_y/2 - my_float , my_float)),
#        Vector((1 * scale_x/2, 1 * scale_y/2 - my_float, my_float)),
#        Vector((-1 * scale_x/2, 1 * scale_y/2 - my_float, 1 + my_float)),
#        Vector((1 * scale_x/2, 1 * scale_y/2 - my_float, 1 + my_float)),
#    ]
    ...
    verts = [
        ...
        #top    
        Vector((-1 * scale_x/2, 1 * scale_y/2, bottom_thickness + top_thickness + scale_z)),
        Vector((1 * scale_x/2, 1 * scale_y/2, bottom_thickness + top_thickness + scale_z)),
        Vector((1 * scale_x/2, -1 * scale_y/2, bottom_thickness + top_thickness + scale_z)),
        Vector((-1 * scale_x/2, -1 * scale_y/2, bottom_thickness + top_thickness + scale_z)),
    ]
